...
@interface Ito_Nowa_Project2Object : KrollCoverageObject {
#else
@interface Ito_Nowa_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Ito_Nowa_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Ito_Nowa_Project2Object *_ito_nowa_project2;
    KrollObject* console;
	BOOL shutdown;
