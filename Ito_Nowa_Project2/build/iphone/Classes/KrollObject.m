...
//@interface Ito_Nowa_Project2Object : NSObject
//@end

@interface Ito_Nowa_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Ito_Nowa_Project2Object class]])
		{
			for (NSString *key in [[(Ito_Nowa_Project2Object*)o modules] allKeys])
			{
