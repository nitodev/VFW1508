...
// in simulator we redefine to format for Ito_Nowa_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.ito_nowa_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ito_nowa_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIIto_Nowa_Project2NativeItemNone = -1, 
	UIIto_Nowa_Project2NativeItemSpinner = -2,
	UIIto_Nowa_Project2NativeItemProgressBar = -3,
	
	UIIto_Nowa_Project2NativeItemSlider = -4,
	UIIto_Nowa_Project2NativeItemSwitch = -5,
	UIIto_Nowa_Project2NativeItemMultiButton = -6,
	UIIto_Nowa_Project2NativeItemSegmented = -7,
	
	UIIto_Nowa_Project2NativeItemTextView = -8,
	UIIto_Nowa_Project2NativeItemTextField = -9,
	UIIto_Nowa_Project2NativeItemSearchBar = -10,
	
	UIIto_Nowa_Project2NativeItemPicker = -11,
	UIIto_Nowa_Project2NativeItemDatePicker = -12,
	
	UIIto_Nowa_Project2NativeItemInfoLight = -13,
	UIIto_Nowa_Project2NativeItemInfoDark = -14,
	
	UIIto_Nowa_Project2NativeItemDisclosure = -15,
	
	UIIto_Nowa_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Ito_Nowa_Project2 instances of
