...
/**
 The base class for all Ito_Nowa_Project2 modules
 */
...
/**
 Ito_Nowa_Project2 Platform calls this method on startup.
 */
-(void)startup;

/**
 Ito_Nowa_Project2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Ito_Nowa_Project2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Ito_Nowa_Project2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Ito_Nowa_Project2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
