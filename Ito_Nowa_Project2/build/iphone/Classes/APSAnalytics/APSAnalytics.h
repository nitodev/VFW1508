 ...
 * to send analytic data that can be viewed on the Ito_Nowa_Project2 Dashboard.
 *
 * For information on getting started with Ito_Nowa_Project2 Platform Services,
