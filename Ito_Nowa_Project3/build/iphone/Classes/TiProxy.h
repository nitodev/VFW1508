...
//Rare exceptions to indicate a bug in the _ito_nowa_project3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Ito_Nowa_Project3 proxies.
 */
