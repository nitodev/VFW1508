...
// in simulator we redefine to format for Ito_Nowa_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.ito_nowa_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ito_nowa_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIIto_Nowa_Project3NativeItemNone = -1, 
	UIIto_Nowa_Project3NativeItemSpinner = -2,
	UIIto_Nowa_Project3NativeItemProgressBar = -3,
	
	UIIto_Nowa_Project3NativeItemSlider = -4,
	UIIto_Nowa_Project3NativeItemSwitch = -5,
	UIIto_Nowa_Project3NativeItemMultiButton = -6,
	UIIto_Nowa_Project3NativeItemSegmented = -7,
	
	UIIto_Nowa_Project3NativeItemTextView = -8,
	UIIto_Nowa_Project3NativeItemTextField = -9,
	UIIto_Nowa_Project3NativeItemSearchBar = -10,
	
	UIIto_Nowa_Project3NativeItemPicker = -11,
	UIIto_Nowa_Project3NativeItemDatePicker = -12,
	
	UIIto_Nowa_Project3NativeItemInfoLight = -13,
	UIIto_Nowa_Project3NativeItemInfoDark = -14,
	
	UIIto_Nowa_Project3NativeItemDisclosure = -15,
	
	UIIto_Nowa_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Ito_Nowa_Project3 instances of
