...
@interface Ito_Nowa_Project3Object : KrollCoverageObject {
#else
@interface Ito_Nowa_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Ito_Nowa_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Ito_Nowa_Project3Object *_ito_nowa_project3;
    KrollObject* console;
	BOOL shutdown;
