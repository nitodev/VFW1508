...
//@interface Ito_Nowa_Project3Object : NSObject
//@end

@interface Ito_Nowa_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Ito_Nowa_Project3Object class]])
		{
			for (NSString *key in [[(Ito_Nowa_Project3Object*)o modules] allKeys])
			{
