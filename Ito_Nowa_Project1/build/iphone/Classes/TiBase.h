...
// in simulator we redefine to format for Ito_Nowa_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.ito_nowa_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ito_nowa_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIIto_Nowa_Project1NativeItemNone = -1, 
	UIIto_Nowa_Project1NativeItemSpinner = -2,
	UIIto_Nowa_Project1NativeItemProgressBar = -3,
	
	UIIto_Nowa_Project1NativeItemSlider = -4,
	UIIto_Nowa_Project1NativeItemSwitch = -5,
	UIIto_Nowa_Project1NativeItemMultiButton = -6,
	UIIto_Nowa_Project1NativeItemSegmented = -7,
	
	UIIto_Nowa_Project1NativeItemTextView = -8,
	UIIto_Nowa_Project1NativeItemTextField = -9,
	UIIto_Nowa_Project1NativeItemSearchBar = -10,
	
	UIIto_Nowa_Project1NativeItemPicker = -11,
	UIIto_Nowa_Project1NativeItemDatePicker = -12,
	
	UIIto_Nowa_Project1NativeItemInfoLight = -13,
	UIIto_Nowa_Project1NativeItemInfoDark = -14,
	
	UIIto_Nowa_Project1NativeItemDisclosure = -15,
	
	UIIto_Nowa_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Ito_Nowa_Project1 instances of
