...
//Rare exceptions to indicate a bug in the _ito_nowa_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Ito_Nowa_Project1 proxies.
 */
