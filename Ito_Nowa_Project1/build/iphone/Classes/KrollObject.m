...
//@interface Ito_Nowa_Project1Object : NSObject
//@end

@interface Ito_Nowa_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Ito_Nowa_Project1Object class]])
		{
			for (NSString *key in [[(Ito_Nowa_Project1Object*)o modules] allKeys])
			{
