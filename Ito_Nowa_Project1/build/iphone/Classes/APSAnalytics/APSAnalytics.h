 ...
 * to send analytic data that can be viewed on the Ito_Nowa_Project1 Dashboard.
 *
 * For information on getting started with Ito_Nowa_Project1 Platform Services,
