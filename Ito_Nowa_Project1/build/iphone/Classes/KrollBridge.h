...
@interface Ito_Nowa_Project1Object : KrollCoverageObject {
#else
@interface Ito_Nowa_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Ito_Nowa_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Ito_Nowa_Project1Object *_ito_nowa_project1;
    KrollObject* console;
	BOOL shutdown;
